...
@PermitAll
@Route(value="dentist/1", layout = DentistLayout.class)
@PageTitle("Appointments | DentClinicApp")
public class DentistOneView extends VerticalLayout
{
    ...
    public DentistOneView(@Autowired AppointmentService appointmentService, @Autowired DentistService dentistService) {
    ...
    private void updateList() {
        Long dentistId = dentistService.fetchAllDentists().get(0).getId();
